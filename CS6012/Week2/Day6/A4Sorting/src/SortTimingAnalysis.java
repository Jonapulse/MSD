...
public class SortTimingAnalysis {
    public static void main(String[] args) {
        ...
        int[] problemSizes = {(int)Math.pow(2, 10), (int)Math.pow(2,11), (int)Math.pow(2,12), (int)Math.pow(2,13), (int)Math.pow(2,14),(int)Math.pow(2,15), (int)Math.pow(2,16), (int)Math.pow(2,17)};
