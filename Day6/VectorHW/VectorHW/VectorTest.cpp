...
int main()
{
  ...
  */
   ...
   */
    ...
    if(testVar != 1)
    {
        ErrorExit("FindMin() - test 1, " + std::to_string(testVar) + " != 1");
    }
    
    testVar = FindMin(vMinSimple2);
    if(testVar != 2)
    {
        ErrorExit("FindMin() - test 2, " + std::to_string(testVar) + " != 2");
    }
    ...
    if(testVar != 3)
    {
        ErrorExit("FindMin() - test 4, " + std::to_string(testVar) + " != 1");
    }
    ...
    if(testVar != 3)
    {
        ErrorExit("FindMax() - test 1, " + std::to_string(testVar) + " != 3");
    }
    
    testVar = FindMax(vMaxSimple2);
    if(testVar != 189)
    {
        ErrorExit("FindMax() - test 2, " + std::to_string(testVar) + " != 189");
    }
    
    testVar = FindMax(vMaxNegative);
    if(testVar != -2)
    {
        ErrorExit("FindMax() - test 3, " + std::to_string(testVar) + " != -2");
    }
    
    testVar = FindMax(vMaxDuplicate);
    if(testVar != 5)
    {
        ErrorExit("FindMax() - test 4, " + std::to_string(testVar) + " != 5");
    }
    ...
    if(testVar != 2)
    {
        ErrorExit("Average() - test 1, " + std::to_string(testVar) + " != 2");
    }
    
    testVar = Average(vAverageSimpleRoundDown);
    if(testVar != 5)
    {
        ErrorExit("Average() - test 2, " + std::to_string(testVar) + " != 5");
    }
    
    testVar = Average(vAverageNegative);
    if(testVar != -2)
    {
        ErrorExit("Average() - test 3, " + std::to_string(testVar) + " != -2");
    }
    
    testVar = Average(vAverageNegativeRoundDown);
    if(testVar != -2) //Huh, I thought that would round down but didn't
    {
        ErrorExit("Average() - test 4, " + std::to_string(testVar) + " != -3");
    }
    
    testVar = Average(vAverageDuplicate);
    if(testVar != 3)
    {
        ErrorExit("Average() - test 5, " + std::to_string(testVar) + " != 3");
    }
