...
{
    //Initialize minValue as the first value (which is the smallest value encountered so far)
...
{
    //Initialize maxValue as the first value (which is the largest value encountered so far)
