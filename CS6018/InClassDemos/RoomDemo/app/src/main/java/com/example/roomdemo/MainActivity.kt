...
class MyViewModel(application: Application) :AndroidViewModel(application) {
    ...
    val tasksReadOnly: Flow<List<TaskEntity?>> = dao.allTasks.stateIn(
    ...
    // Exposing the state by the ViewModel
...
fun TodoList(myVM: MyViewModel) {
    Column(Modifier.fillMaxWidth().padding(50.dp),
        ...
        val observeTasks by myVM.tasksReadOnly.collectAsState(emptyList())
